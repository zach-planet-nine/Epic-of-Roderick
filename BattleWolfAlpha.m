...
@implementation BattleWolfAlpha
...
- (id)initWithBattleLocation:(int)aLocation {
	...
	if (self = [super initWithBattleLocation:aLocation]) {
		...
		defaultImage = [[[[SpriteSheet spriteSheetForImage:[[[PackedSpriteSheet alloc] initWithImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" filter:GL_LINEAR] imageForKey:@"wolf_pack-leader_spritesheet.png"] sheetKey:@"wolf_pack-leader_spritesheet.png" spriteSize:CGSizeMake(80, 40) spacing:10 margin:0] spriteImageAtCoords:CGPointMake(0, 0)] imageDuplicate] retain];
		whichEnemy = kSlime;
