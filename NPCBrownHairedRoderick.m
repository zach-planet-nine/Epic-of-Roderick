...
@implementation NPCBrownHairedRoderick

- (id)initAtLocation:(CGPoint)aLocation {
	
	if (self = [super init]) {
        
        SpriteSheet *bhrSheet = [SpriteSheet spriteSheetForImage:[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEORNPCSpriteSheets.png" controlFile:@"TEORNPCSpriteSheets" imageFilter:GL_LINEAR] imageForKey:@"BrownHairedRoderick.png"] sheetKey:@"BrownHairedRoderick.png" spriteSize:CGSizeMake(30, 40) spacing:10 margin:0];
		float delay = 0.14;
