...
- (id)initWithBattleLocation:(int)aLocation {
	...
	if (self = [super initWithBattleLocation:aLocation]) {
		...
		defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_LINEAR] imageForKey:@"giant.png"] imageDuplicate] retain];
		whichEnemy = kSlime;
