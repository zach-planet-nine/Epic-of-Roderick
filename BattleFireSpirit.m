...
@implementation BattleFireSpirit
...
- (id)initWithBattleLocation:(int)aLocation {
	...
	if (self = [super initWithBattleLocation:aLocation]) {
		...
		defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_LINEAR] imageForKey:@"spirit_fire_70x97.png"] imageDuplicate] retain];
		whichEnemy = kSlime;
