...
@implementation NPCBlackHairedRoderick

- (id)initAtLocation:(CGPoint)aLocation {
	
	if (self = [super init]) {
        
        SpriteSheet *bhrSheet = [SpriteSheet spriteSheetForImage:[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEORNPCSpriteSheets.png" controlFile:@"TEORNPCSpriteSheets" imageFilter:GL_LINEAR] imageForKey:@"BlackHairedRoderick.png"] sheetKey:@"BlackHairedRoderick.png" spriteSize:CGSizeMake(30, 40) spacing:10 margin:0];
		float delay = 0.14;
