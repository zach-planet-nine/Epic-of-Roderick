...
#import "BattleFireDemonRider.h"
#import "GameController.h"
#import "AbstractBattleCharacter.h"
#import "PackedSpriteSheet.h"
#import "Image.h"

@implementation BattleFireDemonRider
...
- (id)initWithBattleLocation:(int)aLocation
{
    ...
    if (self) {
        ...
        defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_NEAREST] imageForKey:@"demon_rider.png"] imageDuplicate] retain];
        ...
        ai[3] = EnemyAISet(kAIEssencePercent, 70, kAIAnyCharacter, 0, kAIEnemyFireAllCharacters);
    }
