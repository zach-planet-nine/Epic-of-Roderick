...
#import "BattleFrostDemonRider.h"
#import "GameController.h"
#import "AbstractBattleEnemy.h"
#import "PackedSpriteSheet.h"
#import "Image.h"

@implementation BattleFrostDemonRider
...
- (id)initWithBattleLocation:(int)aLocation
{
    ...
    if (self) {
        ...
        defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_NEAREST] imageForKey:@"forst_demon_rider copy.png"] imageDuplicate] retain];
        ...
        ai[3] = EnemyAISet(kAIEssencePercent, 70, kAIAnyCharacter, 0, kAIEnemyWaterAllCharacters);
    }
