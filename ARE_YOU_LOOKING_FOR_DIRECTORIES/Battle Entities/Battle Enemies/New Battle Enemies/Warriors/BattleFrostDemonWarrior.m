...
#import "BattleFrostDemonWarrior.h"
#import "GameController.h"
#import "PackedSpriteSheet.h"
#import "Image.h"

@implementation BattleFrostDemonWarrior
...
- (id)initWithBattleLocation:(int)aLocation
{
    ...
    if (self) {
        ...
        defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_NEAREST] imageForKey:@"frost_demon_warrior.png"] imageDuplicate] retain];
		whichEnemy = kSlime;
