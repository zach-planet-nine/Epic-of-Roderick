...
@implementation BattleGiantBerserker
...
- (id)initWithBattleLocation:(int)aLocation {
	...
	if (self = [super initWithBattleLocation:aLocation]) {
		...
		defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_LINEAR] imageForKey:@"giant_beserker_sword.png"] imageDuplicate] retain];
		whichEnemy = kSlime;
