...
@implementation NPCBlondeHairedRoderick

- (id)initAtLocation:(CGPoint)aLocation {
	
	if (self = [super init]) {
        
        NSLog(@"Trying to get the sprite sheet.");
        SpriteSheet *bhrSheet = [SpriteSheet spriteSheetForImage:[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEORNPCSpriteSheets.png" controlFile:@"TEORNPCSpriteSheets" imageFilter:GL_LINEAR] imageForKey:@"BlondeHairedRoderick.png"] sheetKey:@"BlondeHairedRoderick.png" spriteSize:CGSizeMake(30, 40) spacing:10 margin:0];
		float delay = 0.14;
        
        NSLog(@"got the spritesheet.");
