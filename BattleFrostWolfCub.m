...
@implementation BattleFrostWolfCub
...
- (id)initWithBattleLocation:(int)aLocation {
	...
	if (self = [super initWithBattleLocation:aLocation]) {
		...
		defaultImage = [[[[SpriteSheet spriteSheetForImage:[[[PackedSpriteSheet alloc] initWithImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" filter:GL_LINEAR] imageForKey:@"frost_wolf_cub_spritesheet.png"] sheetKey:@"frost_wolf_cub_spritesheet.png" spriteSize:CGSizeMake(80, 40) spacing:10 margin:0] spriteImageAtCoords:CGPointMake(0, 0)] imageDuplicate] retain];
		whichEnemy = kSlime;
