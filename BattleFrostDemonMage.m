...
#import "BattleFrostDemonMage.h"
#import "GameController.h"
#import "AbstractBattleCharacter.h"
#import "PackedSpriteSheet.h"
#import "Image.h"

@implementation BattleFrostDemonMage
...
- (id)initWithBattleLocation:(int)aLocation
{
    ...
    if (self) {
        ...
        defaultImage = [[[[PackedSpriteSheet packedSpriteSheetForImageNamed:@"TEOREnemies.png" controlFile:@"TEOREnemies" imageFilter:GL_NEAREST] imageForKey:@"frost_demon.png"] imageDuplicate] retain];
		whichEnemy = kSlime;
		...
		experience = 55 * level;
        damageDealt = 0;
        ai[0] = EnemyAISet(kAIEssencePercent, 80, kAIAnyCharacter, 0, kAIEnemyWaterAllCharacters);
        ai[1] = EnemyAISet(kAIEndurancePercent, 80, kAICharacterWithLowestHP, 0, kAIEnemySmash);
        ai[2] = EnemyAISet(kAIEssencePercent, 60, kAIAnyCharacter, 0, kAIEnemyWater);
	}
